...
@if ($errors->any())
    ...
    <div class="plans-create-container">
            <h1 class="create-info">Editando usuário <strong>{{ $planUser->plan_user_name }}</strong>:</h1>
            <form action="/users/update/{{ $planUser->id }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="plan_user_name">Nome do Usuário:</label>
                    <input type="text" class="form-control" id="plan_user_name" name="plan_user_name" value="{{ $planUser->plan_user_name }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="plan_user_value" name="plan_user_value" value="{{ $planUser->plan_user_value }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="plan_user_number" name="plan_user_number" value="{{ $planUser->plan_user_number }}">
                </div>
                <div class="form-group">
                    <div>
