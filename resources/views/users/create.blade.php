    ...
    <div class="plans-create-container">
            ...
            <form action="/users/" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="plan_user_name" name="plan_user_name" value="{{ old('plan_user_name') }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="plan_user_value" name="plan_user_value" value="{{ old('plan_user_value') }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="plan_user_number" name="plan_user_number" value="{{ old('plan_user_number') }}">
                </div>
                <div class="form-group">
                    <div>
